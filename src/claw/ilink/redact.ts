/**
 * 日志脱敏工具（红化 token / authorization / context_token）。
 *
 * Vendor 源: @tencent-weixin/openclaw-weixin@2.4.6/dist/src/util/redact.js
 */
 ...
 */
export function redactToken(token: string | undefined, prefixLen: number = DEFAULT_TOKEN_PREFIX_LEN): string {
 ...
 */
export function redactBody(body: string | undefined, maxLen: number = DEFAULT_BODY_MAX_LEN): string {
